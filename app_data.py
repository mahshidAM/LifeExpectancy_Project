...
def get_DataFrame():
    ...
    cleaned_df = df.melt(id_vars=['Country Name','Country Code'], var_name="year")
    cleaned_df.rename({'Country Name':'country','Country Code':'country_code'},axis=1,inplace=True)
